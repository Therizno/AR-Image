...
public class AugmentedImageFragment extends ArFragment {
  ...
  private static final String COUCH_IMAGE_NAME = "couch.jpeg";
  private static final String LAPTOP_IMAGE_NAME = "Laptop.jpg";
  ...
  private boolean setupAugmentedImageDatabase(Config config, Session session) {
    ...
    if (USE_SINGLE_IMAGE) {
      ...
      //Couch image
      Bitmap augmentedImageBitmap = loadAugmentedImageBitmap(assetManager, COUCH_IMAGE_NAME);
      if (augmentedImageBitmap == null) {
        return false;
      }

      augmentedImageDatabase = new AugmentedImageDatabase(session);
      augmentedImageDatabase.addImage(COUCH_IMAGE_NAME, augmentedImageBitmap);

      //Laptop Image
      Bitmap augmentedImageBitmap2 = loadAugmentedImageBitmap(assetManager, LAPTOP_IMAGE_NAME);
      if (augmentedImageBitmap2 == null) {
        return false;
      }

      augmentedImageDatabase.addImage(LAPTOP_IMAGE_NAME, augmentedImageBitmap2);
