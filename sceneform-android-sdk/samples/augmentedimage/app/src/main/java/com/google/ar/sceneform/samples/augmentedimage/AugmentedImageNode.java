...
public class AugmentedImageNode extends AnchorNode {
  ...
  */
  ...
  public AugmentedImageNode(Context context, String imgName) {
  ...
  public void setImage(AugmentedImage image) {
    ...
    */
    ...
    /*
    Vector3 from viewer perspective:
      param 1: y
      param 2: x
      param 3: z

      z points downwards rather than up
    */

    cornerNode.setLocalRotation(Quaternion.axisAngle(new Vector3(0, 1f, -1f), 180));
    cornerNode.setLocalPosition(new Vector3(0, 0, 0.2f));
